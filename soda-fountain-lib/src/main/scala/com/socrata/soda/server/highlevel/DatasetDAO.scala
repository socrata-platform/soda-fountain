...
object DatasetDAO {
  ...
  case class RollupRelations(rollupRelations: Seq[RollupDatasetRelation]) extends SuccessResult
  ...
  case class RollupRelationsNotFound(dataset: DatasetInternalName, side: String) extends FailResult

 ...
 */
class GeoregionMatchOnStringHandler[T](config: Config, discovery: ServiceDiscovery[T], http: HttpClient)
  extends GeoregionMatchHandler[T, String](config, discovery, http){

...
import com.socrata.soda.server.id.{ColumnId, DatasetInternalName, RollupName, RowSpecifier}
...
case class NoRelationsFoundError(dataset: DatasetInternalName, side:String) extends DCRollupError

...
class StringToSoQLLiteralValueTranslation extends FunSuite with MustMatchers {
  ...
  test("JSON rep type check with double"){ testRep("123.45", "123.45", SoQLDouble) }
  test("JSON rep type check with money"){ testRep("123.45", "123.45", SoQLMoney) }
  test("JSON rep type check with fixed timestamp"){ testRep("2013-06-03T02:26:05.123Z", "2013-06-03T02:26:05.123Z", SoQLFixedTimestamp) }
  test("JSON rep type check with floating timestamp"){ testRep("2013-06-03T02:26:05.123", "2013-06-03T02:26:05.123", SoQLFloatingTimestamp) }
  test("JSON rep type check with date"){ testRep("2013-06-03", "2013-06-03", SoQLDate) }
  test("JSON rep type check with time"){ testRep("02:26:05.123", "02:26:05.123", SoQLTime) }

...
object SodaFountainLib {
  lazy val settings: Seq[Setting[_]] = BuildSettings.projectSettings() ++ Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.socrata"        %% "socrata-http-client"         % "2.3.2",
      "com.socrata"        %% "socrata-http-server"         % "2.3.2",
      "com.socrata"        %% "socrata-thirdparty-utils"    % "2.5.0",
      "com.socrata"        %% "soql-analyzer"               % "0.3.0",
      "com.socrata"        %% "soql-brita"                  % "[1.2.1,2.0.0)",
      "com.socrata"        %% "soql-standalone-parser"      % "0.3.0",
      "com.socrata"        %% "soql-stdlib"                 % "0.3.0" exclude ("javax.media", "jai_core"),
      "com.socrata"        %% "soql-types"                  % "[0.3.2,1.0.0)",

...
object SodaFountainLib {
  lazy val settings: Seq[Setting[_]] = BuildSettings.projectSettings() ++ Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.socrata"        %% "soql-analyzer"               % "0.1.1-SNAPSHOT",
      "com.socrata"        %% "soql-brita"                  % "[1.2.1,2.0.0)",
      "com.socrata"        %% "soql-standalone-parser"      % "0.1.1-SNAPSHOT",
      "com.socrata"        %% "soql-stdlib"                 % "0.1.1-SNAPSHOT",
      "com.socrata"        %% "soql-types"                  % "0.1.1-SNAPSHOT",

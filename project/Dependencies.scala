...
object Dependencies {
  ...
  val astyanaxCassandra = astyanaxExcludes("com.netflix.astyanax" % "astyanax-cassandra" % versions.astyanaxVersion)
  val astyanaxThrift    = astyanaxExcludes("com.netflix.astyanax" % "astyanax-thrift"    % versions.astyanaxVersion)
  ...
  val socrataGeocoders          = "com.socrata"     %% "geocoders"                   % versions.socrataGeocoders
